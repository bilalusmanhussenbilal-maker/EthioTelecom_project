...
/**
 * Local change to the registry component: the upstream menu button renders a bare `<a>`, which
 * makes every navigation a full document load. In this app that would remount the provider tree
 * and throw away in-memory sync state on each click, so it routes through Next's Link instead.
 */
